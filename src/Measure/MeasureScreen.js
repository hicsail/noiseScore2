...
import { Platform, PermissionsAndroid, ScrollView, StyleSheet, TouchableOpacity, View } from 'react-native';
...
/* * * * *
  RENDER
* * * * * */
const buttonHeight = constants.height / 15;
...
export default class MeasureScreen extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot) {
        if (this.props.route.params !== undefined) {
            if (this.props.route.params.fromSubmit) {
                this.setState({
                    decibels: [],
                    started: false,
                    stopped: false,
                ...
                this.props.route.params.fromSubmit = false;
            }
        }
    }
    ...
    render() {
        ...
        return (
            <View style={{height: '100%', width: '100%'}}>
                <CustomHeader navigation={this.props.navigation} showBack={false} showAccount={false}/>
