                        ...
                        <View style={styles.questionBlock}>
                            ...
                            <View style={styles.percentageBlock}>
                                ...
                                <Slider
                                    ...
                                    step={step}
                                    maximumValue={100}
                                    maximumTrackTintColor={constants.colors.darkGray}
                                    minimumTrackTintColor={constants.colors.brightGreen}
                                    thumbTintColor={constants.colors.brightGreen}
...
const styles = StyleSheet.create({
        ...
        text: {
            fontSize: constants.width * 0.055,
            color: 'black',
