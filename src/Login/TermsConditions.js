...
export default class TermsConditions extends React.Component {
    ...
    next() {
        // Valid user info and create user, then move to MapScreen
        ...
        AsyncStorage.getItem('formData', null).then(function (ret) {
            ...
            axios.post('http://' + constants.IP_ADDRESS + '/api/signup', userData).then(function (response) {
                // save relevant information and nav to home page
                console.log('---------------------------------------------');
